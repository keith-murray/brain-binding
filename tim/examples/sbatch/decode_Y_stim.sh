#!/bin/bash
#SBATCH --job-name=decode_Y_stim
#SBATCH --output=logs/decode_Y_stim_%j.out
#SBATCH --error=logs/decode_Y_stim_%j.err
...
python ${SCRIPT_DIR}/decode_meg.py --experiment Y_stim
