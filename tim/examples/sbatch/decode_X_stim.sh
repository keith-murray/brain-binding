#!/bin/bash
#SBATCH --job-name=decode_X_stim
#SBATCH --output=logs/decode_X_stim_%j.out
#SBATCH --error=logs/decode_X_stim_%j.err
...
python ${SCRIPT_DIR}/decode_meg.py --experiment X_stim
