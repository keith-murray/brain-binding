#!/bin/bash
#SBATCH --job-name=decode_response
#SBATCH --output=logs/decode_response_%j.out
#SBATCH --error=logs/decode_response_%j.err
...
python ${SCRIPT_DIR}/decode_meg.py --experiment response
