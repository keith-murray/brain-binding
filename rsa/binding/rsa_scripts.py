...
def run_lss_and_average(
    ...
    confounds, sample_mask = nl.interfaces.fmriprep.load_confounds(
        bold_path, strategy=confound_strategy,
        fd_threshold=fd_threshold, n_compcor=n_compcor,
        motion=motion, demean=demean_confounds,
    )
...
def main(argv=None):
    ...
    parser.add_argument("--probseg-threshold", type=float, default=0.4)
